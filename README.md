...
- For release 2.4 and up, **PHP 8.1** is the minimum required version for this library. Previous releases requires **PHP 8.0**.
- Update April 2023: Since our release 2.3 and up, **PHP 8.0** is the minimum required version for this library. Previous releases requires **PHP 7.4**.
...
*Note*: Most functions return string values, unless otherwise specified.
